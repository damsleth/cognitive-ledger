...
- [ ] Obsidian-importeren (ledger/importers/backends/obsidian) er dod: state sier vault_root=/Users/damsleth/Code/notes som ikke finnes (ekte vault er ~/brain/notes), siste kjoring 2026-01-21. Verre: staten ligger pa legacy-stien 08_indices/obsidian_import_state.json mens koden leser 08_indices/importers/obsidian/state.json (models.py:84 -> backend_state_dir), sa de 50 prosesserte filene er usynlige og en ny kjoring starter fra null. Det finnes heller ingen CLI-entrypoint (ingen treff i cli.py eller pyproject.toml) - avklar om backenden fortsatt skal leve for du re-pointer den. Funnet 2026-09-16.
